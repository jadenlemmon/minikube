...
var tunnelCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		StartTunnel(cname, cleanup, bindAddress, daemon)
	},
}

func StartTunnel(cname string, cleanup bool, bindAddress string, daemon bool) {
...
func outputTunnelStarted(d bool) {
...
func init() {
	...
	tunnelCmd.Flags().BoolVarP(&daemon, "daemon", "d", false, "run the tunnel command as a daemon")
